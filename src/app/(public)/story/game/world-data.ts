...
export const PLAYER_SPEED = 2.4; // pixels per frame at full velocity
export const PLAYER_ACCEL = 0.12; // acceleration per frame
export const PLAYER_DECEL = 0.06; // deceleration (friction) per frame
